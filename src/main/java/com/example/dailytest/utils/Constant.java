...
//    public static String callbackBaseUrl;
    ...
    public static final String BASE_URL = "https://49.4.92.191:8743";//"https://10.10.10.97:8743";
    //public static final String BASE_URL = "https://180.101.147.89:8743";

    //please replace the appId and secret, when you use the demo.
    public static final String APPID = "PnB_xNSiIp08g6AnOcG12NBtLdEa";//"uxZaARB0aa8XoYz6ZYMO_DmeA24a";
    public static final String SECRET = "tEQl524x_SicAnlmDaUePOPfmn4a";//"OUaq6VSjAdRDGYgaDPOijxdxMXoa";
    //public static final String APPID = "lT3ihB8_QH5CYsMjn3dfnffeLE0a";
    //public static final String SECRET = "66WO0ifHd03fnjVTcvCDy2sf4bAa";
    ...
    //public static final String CALLBACK_BASE_URL = new StringBuilder(ConstantProperties.getCallbackBaseUrl()).append(ConstantProperties.getTestValue()).toString();//ConstantProperties.getCallbackBaseUrl()+ConstantProperties.getTestValue();
    public static final String CALLBACK_BASE_URL = ConstantProperties.getCallbackBaseUrl()+ConstantProperties.getTestValue();
